                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">anwarnafisneo@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">linkedin.com/in/nafisanwar</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">github.com/NafisAnwar</p>
                    </div>
                  </div>
                </div>
